...
enum Api {
  ChangePassword = '/sys_admin/user/change_password',
  CreateUser = '/sys_admin/user/create',
  DeleteUser = '/sys_admin/user/delete',
  GetPermCode = '/sys_admin/user/perm',
  GetUserById = '/sys_admin/user',
  GetUserInfo = '/sys_admin/user/info',
  GetUserList = '/sys_admin/user/list',
  Login = '/sys_admin/user/login',
  LoginByEmail = '/sys_admin/user/login_by_email',
  LoginBySms = '/sys_admin/user/login_by_sms',
